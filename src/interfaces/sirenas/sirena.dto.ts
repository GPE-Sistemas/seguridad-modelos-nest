...
enum ETipoEventoSirena {
  ...
  ENCENDER_BALIZA_BOTON = 'ENCENDER_BALIZA_BOTON',
  ENCENDER_SONIDO_BOTON = 'ENCENDER_SONIDO_BOTON',
  ENCENDER_PANICO_BOTON = 'ENCENDER_PANICO_BOTON',
}
...
export type TipoEventoSirena =
  ...
  | 'ENCENDER_BALIZA_BOTON'
  | 'ENCENDER_SONIDO_BOTON'
  | 'ENCENDER_PANICO_BOTON';
