...
export * from "./interfaces/derivacion";
...
export * from "./interfaces/transaccion";
export * from "./interfaces/dominio";
export * from "./interfaces/estacionamiento";
export * from "./interfaces/zona-estacionamiento";
export * from "./interfaces/infracciones";
export * from "./interfaces/dominio-exento";
export * from "./interfaces/dominio-lectura";
